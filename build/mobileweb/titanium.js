...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by danmoellering",
		deployType: "development",
		description: "not specified",
		guid: "80706993-3365-458a-8591-5fc0b712c2ef",
		id: "com.moelleringstudios.go",
		name: "GO",
		names: {},
		publisher: "danmoellering",
		url: "http://moelleringstudios.com",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","yHs68KXzcPdY2ik6YuOOYqKqXgSRC20R");
p.setString("acs-api-key-development","4FCZ4dVtAjX8wXkJxqPI3dGIo2gj0AIB");
p.setString("acs-oauth-secret-development","26rQjT5RRCcjV1Mp8AM7C6cbr4QEjy8A");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","nP20ziQFfiUT34mVdZwsSS3WioYvU7Es");
p.setString("acs-oauth-key-development","CgtO78PEswCvTioT3G8IkCvGiwSBDV2o");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","3jrJJKZBmZ5yfOk4uBCGGSmlESfEAlmT");
});
