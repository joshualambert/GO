 ...
 * Copyright (c) 2009-2011 by GO, Inc. All Rights Reserved.
...
//@interface GOObject : NSObject
//@end

@interface GOObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GOObject class]])
		{
			for (NSString *key in [[(GOObject*)o modules] allKeys])
			{
