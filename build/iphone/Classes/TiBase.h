...
// in simulator we redefine to format for GO Developer console
...
{\
	NSString * exceptionName = [@"org.go." stringByAppendingString:NSStringFromClass([self class])];\
...
enum {
	UIGONativeItemNone = -1, 
	UIGONativeItemSpinner = -2,
	UIGONativeItemProgressBar = -3,
	
	UIGONativeItemSlider = -4,
	UIGONativeItemSwitch = -5,
	UIGONativeItemMultiButton = -6,
	UIGONativeItemSegmented = -7,
	
	UIGONativeItemTextView = -8,
	UIGONativeItemTextField = -9,
	UIGONativeItemSearchBar = -10,
	
	UIGONativeItemPicker = -11,
	UIGONativeItemDatePicker = -12,
	
	UIGONativeItemInfoLight = -13,
	UIGONativeItemInfoDark = -14,
	
	UIGONativeItemDisclosure = -15,
	
	UIGONativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GO instances of
